import unittest
from TrailRunner.trailrunner import Session, User
...
class Testuser(unittest.TestCase):
    ...
    def test_computeAveragePace(self):
        self.user = User()
        ...
        actual = self.user.compute_avg_pace()
        expected = timedelta(seconds=346, milliseconds=667)

        self.assertAlmostEqual(expected.total_seconds(), actual.total_seconds(), delta=0.1)
